...
packages=(
python3-yamllint # Dependency needed by test-yaml-valid. This one is mentioned https://github.com/os-autoinst/os-autoinst-distri-opensuse/blob/9a8b06f39afe23b1a367453f2d5c4ed676815c1a/CONTRIBUTING.md?plain=1#L48
